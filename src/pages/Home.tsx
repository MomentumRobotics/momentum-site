        ...
        <div className="min-h-screen">
          ...
          <section className="py-16 px-4  bg-gray-950">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6  ml-14 mr-14">
              <h3 className="text-3xl mb-4 text-gray-900 dark:text-white text-center font-extrabold"><span
                  className="text-black">First</span> <span className="text-orange-600"> Tech Challenge </span></h3>
              <p className="text-gray-600 dark:text-gray-300">
                The First Tech Challenge (FTC) is a robotics competition for young people, where student teams design,
                build, and program robots. The goal is to teach students about science, technology, engineering, and
                mathematics (STEM), while also fostering teamwork and problem-solving skills. The robots are required to
                complete specific tasks in a new game each year.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6  ml-14 mr-14 mt-1">
              <h3 className="text-3xl mb-4 text-gray-900 dark:text-white text-center font-extrabold"><LinearGradient
                  gradient={['to top', '#003249 ,#007ea7,#80ced7, #ccdbdc']}>Who We Are ? </LinearGradient></h3>
              <p className="text-gray-600 dark:text-gray-300">
                The Momentum team is a project launched by the well-known and nationally qualified team Velocity, within
                the "Nicolae Iorga" National College. The Momentum team is the college's way of leaving its mark within
                this community and fostering a creative generation, equipped with both technical knowledge and social
                skills.</p>
            </div>
          </section>
          ...
          <section className="py-16 px-4 bg-gray-50 dark:bg-gray-800">
            <div className="container mx-auto">
              ...
              <p className="text-center text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-12">
                Follow us on social media to stay updated with our latest achievements, events, and behind-the-scenes
                moments. Join our growing community of robotics enthusiasts!
              </p>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden">
                  ...
                  <div className="h-[400px]" style={{border: "none", overflow: "hidden", alignContent: "center"}}>
                    <iframe
                        ...
                        style={{border: "none", overflow: "hidden", paddingTop: "100px"}}></iframe>
                  </div>
                </div>
              </div>
            </div>
