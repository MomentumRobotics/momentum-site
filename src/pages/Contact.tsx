            ...
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-20 px-4">
              <div className="container mx-auto text-center text-white">
                ...
                <ul className="list-none space-y-6 text-left max-w-2xl mx-auto mb-8">
                  ...
                  <li className="text-xl text-gray-600 dark:text-gray-300">
                    <strong>Develop valuable STEM and teamwork skills:</strong> Not only will you enhance your technical
                  ...
                  <li className="text-xl text-gray-600 dark:text-gray-300">
                    <strong>Make friends who share your passions:</strong> Join a community of like-minded students who
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 mt-6">
                  ...
                  technology, and the drive to succeed. We believe in providing a supportive, collaborative environment
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">+40 748 583 856 Jercan Bianca, Lidera Momentum</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
